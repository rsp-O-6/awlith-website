      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
              We build AI automations, Web3 products, and custom software—engineered for performance, security, and scale.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["AI & Automation", "Blockchain & Web3", "Custom Software", "Cloud Architecture", "Security Audits"].map((s) => (
                <li key={s}>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © 2026 Awlith Technologies. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
            Office No 156, Evershine Mall, Malad, Mumbai 400064, India
          </p>
        </div>
      </div>
    </footer>
